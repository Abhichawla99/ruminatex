...
const staticRoutes: StaticRoute[] = [
  ...
  { path: '/ai-brand-videos', changeFrequency: 'monthly', priority: 0.8 },
  { path: '/ai-video-ads', changeFrequency: 'monthly', priority: 0.8 },
  { path: '/ai-short-form-video', changeFrequency: 'monthly', priority: 0.8 },
  ...
  { path: '/ai-video-marketing-agency', changeFrequency: 'monthly', priority: 0.8 },
  { path: '/ai-reel-creation', changeFrequency: 'monthly', priority: 0.8 },
  { path: '/ai-tiktok-video-agency', changeFrequency: 'monthly', priority: 0.8 },
  { path: '/ai-video-strategy', changeFrequency: 'monthly', priority: 0.8 },
  { path: '/ai-creative-studio', changeFrequency: 'monthly', priority: 0.8 },
  { path: '/ai-generated-brand-content', changeFrequency: 'monthly', priority: 0.8 },
  { path: '/ai-content-workflow-automation', changeFrequency: 'monthly', priority: 0.8 },
  { path: '/ai-influencer-style-content', changeFrequency: 'monthly', priority: 0.8 },
  { path: '/ai-video-production-company', changeFrequency: 'monthly', priority: 0.8 },
  { path: '/ai-product-videos', changeFrequency: 'monthly', priority: 0.8 },
  { path: '/ai-motion-content', changeFrequency: 'monthly', priority: 0.8 },
  { path: '/ai-video-for-ecommerce', changeFrequency: 'monthly', priority: 0.8 },
  { path: '/ai-visual-content-for-companies', changeFrequency: 'monthly', priority: 0.8 },
  { path: '/ai-social-media-video', changeFrequency: 'monthly', priority: 0.8 },
  ...
  { path: '/how-we-make-an-ai-brand-film', changeFrequency: 'monthly', priority: 0.8 },
