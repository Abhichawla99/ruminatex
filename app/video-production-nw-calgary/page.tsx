...
const schema = {
  ...
  "@type": "LocalBusiness",
  name: "Ruminate X — Video Production NW Calgary",
  description: "AI-powered video production for NW Calgary businesses.",
  telephone: "+15878049266",
  address: { "@type": "PostalAddress", addressLocality: "Calgary", addressRegion: "AB", addressCountry: "CA" },
  areaServed: { "@type": "Place", name: "Northwest Calgary" },
};
    ...
    <>
      ...
      <main className="min-h-screen bg-white">
        <div className="max-w-4xl mx-auto px-6 py-20">
          <p className="text-sm uppercase tracking-widest text-red-600 mb-4">NW Calgary, Alberta</p>
          <h1 className="text-5xl md:text-6xl font-bold mb-6 text-slate-900 leading-tight">Video Production — NW Calgary</h1>
          <p className="text-xl text-slate-600 mb-4">Professional video for NW Calgary's vibrant communities and businesses. From Tuscany and Rocky Ridge to Kensington and Varsity — broadcast-quality video from $500, delivered in 48 hours.</p>
          <div className="flex flex-wrap gap-4 mb-12">
            <Link href="/contact" className="bg-slate-900 text-white px-6 py-3 font-bold text-sm uppercase tracking-widest hover:bg-slate-700 transition">Get an NW Calgary Quote</Link>
          ...
          <section className="mb-16">
            <h2 className="text-3xl font-bold mb-4 text-slate-900">NW Calgary Communities We Serve</h2>
            <div className="flex flex-wrap gap-2">
              {["Tuscany", "Rocky Ridge", "Royal Oak", "Nolan Hill", "Sage Hill", "Evanston", "Sherwood", "Kincora", "Citadel", "Hamptons", "Varsity", "Dalhousie", "Edgemont", "Hawkwood", "Kensington", "Hillhurst", "Montgomery", "Bowness", "Silver Springs"].map(n => (
          ...
          <section className="mb-16">
            <h2 className="text-3xl font-bold mb-6 text-slate-900">NW Calgary Business Video Services</h2>
            <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
              {[
                ...
                { name: "Fitness Studio Video", href: "/video-production-calgary-fitness" },
          ...
          <section className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                ...
                { href: "/video-production-airdrie", label: "Video Production Airdrie" },
                { href: "/video-production-near-me", label: "Video Production Near Me" },
                { href: "/contact", label: "Get an NW Calgary Quote" },
              ].map(({ href, label }) => (
          ...
          <section className="bg-slate-900 text-white p-12 rounded-lg">
            <h2 className="text-3xl font-bold mb-2">NW Calgary's Video Production Studio</h2>
            <p className="text-slate-400 text-sm mb-4">📍 Calgary, AB · (587) 804-9266 · abhi@paperkites.co</p>
            <p className="text-slate-300 mb-8">Professional video for every NW Calgary business. From $500, in 48 hours.</p>
